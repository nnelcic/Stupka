...
const UpdateMovie: React.FC<UpdateMovieFormProps> = ({ setOccuredError, setShowError, close, movie, setRerender }) => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            updateMovie(movie.id, originalTitle, title, duration, type, releaseDate, posterUrl, description,
