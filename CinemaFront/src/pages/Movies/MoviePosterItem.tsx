            ...
            <Card.Footer>
                {likeState ?
                    <div className="col text-center">
                        <Button onClick={() => handleLike(movie.id)} variant="outline-danger">
                    ...
                    :
                    <div className="col text-center">
                        <Button onClick={() => handleUnlike(movie.id)} variant="outline-secondary">
                            <svg xmlns="https://www.svgrepo.com/show/346774/dislike.svg" width="20" height="20" fill="gray" className="bi bi-heart-fill" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314z"/>
                            </svg>
                        </Button>
                    </div>
